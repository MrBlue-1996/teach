...
- **Missing-stimulus severity for internal demo**: artifact-reference findings warn for demo/internal packs and remain errors for release-mode packs. This keeps internal demo authoring visible without blocking non-release validation, while preserving strict release gates.
