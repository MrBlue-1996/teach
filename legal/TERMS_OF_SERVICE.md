...
By accessing or using the TopShelf Teaching platform ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the Service.

## 2. Description of Service

TopShelf Teaching is an AI-powered educational platform that provides:

- Interactive learning content for IT certifications
...
- Subscription fees are as described on our pricing page
...
- Pro-rated refunds are not provided for mid-cycle cancellations
- Refund requests must be submitted to billing@topshelfservice.com

## 5. Acceptable Use

### 5.1 You May:

- Access content for personal or authorized organizational learning
- Share achievements and badges on professional networks
- Use the Service in accordance with your subscription level

### 5.2 You May Not:

- Share account credentials with unauthorized users
- Redistribute, copy, or resell course content
...
- All content, software, and materials are owned by TopShelf Service LLC
...
## 8. Educational Institution Terms

### 8.1 School and District Accounts

- Administrators are responsible for managing user access
- Student data is handled in accordance with FERPA requirements
- Schools must obtain necessary parental consents

### 8.2 Seat Licenses

- Seats are non-transferable once assigned to a user
- Unused seats may not be carried over between billing periods
- Seat counts may be adjusted at renewal
...
- We make reasonable efforts to ensure content accuracy
- Content is for educational purposes and may not reflect current industry standards
- We do not guarantee specific learning outcomes or certification results
...
You agree to indemnify and hold harmless TopShelf Service LLC, its officers, directors, employees, and agents from any claims, damages, or expenses arising from:
...
Any disputes will be resolved through binding arbitration under the rules of the American Arbitration Association, except for claims eligible for small claims court.
...
- Earned badges remain verifiable

## 15. General Provisions

### 15.1 Entire Agreement

These Terms constitute the entire agreement between you and TopShelf Service LLC.
...
- Support: support@topshelfservice.com
- Billing: billing@topshelfservice.com

---

_By using TopShelf Teaching, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service._
