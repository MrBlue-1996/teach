...
export function determineAvailableFeatures(
  ...
  return {
    ...
    smallPacks: true,
    wasmInference: isEnhancedOrFull && capabilities.wasm.available,
    localEmbeddings: isEnhancedOrFull && capabilities.wasm.available && capabilities.wasm.simd,
    webGPU: isFull && capabilities.webGPU.available,
    localLLM: isFull && capabilities.webGPU.available,
